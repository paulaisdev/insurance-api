...
@Component("BOLETO")
public class JurosBoleto implements CalculoJuros {

    private static final Logger logger = LoggerFactory.getLogger(JurosBoleto.class);
    ...
    public BigDecimal calcularJuros(Parcela parcela) {
        ...
        logger.info("Cálculo de juros para BOLETO - Parcela ID: {}, Dias em atraso: {}, Juros calculado: {}",
